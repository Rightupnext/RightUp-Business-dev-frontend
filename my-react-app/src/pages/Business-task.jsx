      ...
      <div className="max-w-screen-xl mx-auto px-4 lg:px-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-slate-800 leading-tight">Team Task View</h1>
        ...
        {!loading && groups.length === 0 && (
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <p className="text-slate-400 text-sm mt-1">
              {filterDate ? "Try clearing the date filter" : `No records found for ${selectedMemberObj?.name || "this member"}`}
            </p>
          </div>
        )}
                  ...
                  <div className="p-5">
                    ...
                    <div className="flex flex-wrap items-start justify-between gap-4 mb-5">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-[10px] text-slate-400 uppercase tracking-widest font-medium">Date</p>
                          <p className="text-sm font-bold text-slate-800">{formatDate(group.date)}</p>
                        </div>
                        {isActive && (
                      ...
                      {TIME_SLOTS.map(({ key, label, color }) => (
                        <div
                          ...
                          className={`border rounded-xl p-2 text-center ${
                            group[key] ? TILE_COLOR[color] : "bg-slate-50 border-slate-100 text-slate-400"
                          }`}
                        >
                          <p className="text-[9px] uppercase tracking-wider font-semibold truncate opacity-70">{label}</p>
                                ...
                                >
                                    ...
                                    {task.projname ? (
                                      <div className="flex items-center gap-2">
                                        <div className="w-6 h-6 rounded-md bg-indigo-100 text-indigo-700 flex items-center justify-center text-[10px] font-bold flex-shrink-0">
                                          {task.projname.charAt(0).toUpperCase()}
                                        </div>
                                        <span className="text-slate-700 font-medium text-xs leading-snug">{task.projname}</span>
                                      </div>
                                    ) : (
                                  ...
                                  <td className="px-3 py-3 align-top">
                                    <p className="text-slate-700 text-xs leading-relaxed whitespace-pre-wrap">
                                      {task.name || <span className="text-slate-300">—</span>}
                                    </p>
                                  </td>
                                  ...
                                  <td className="px-3 py-3 align-top">
                                    <div className="flex items-center gap-1">
                                      ...
                                      <span className="text-xs font-semibold text-slate-600">{formatToISTTime(task.timing)}</span>
                                    </div>
                                  </td>
                                  ...
                                  <td className="px-3 py-3 align-top">
                                    {task.endTiming ? (
                                      <div className="flex items-center gap-1">
                                        ...
                                        <span className="text-xs font-semibold text-slate-600">{formatToISTTime(task.endTiming)}</span>
                                      </div>
                                    ) : (
                            ...
                            <tr>
                              <td colSpan={7} className="py-10 text-center">
                                <div className="flex flex-col items-center gap-2">
                                  ...
                                  <p className="text-slate-400 text-xs">No tasks recorded</p>
                                </div>
                              </td>
                            </tr>
                          )}
